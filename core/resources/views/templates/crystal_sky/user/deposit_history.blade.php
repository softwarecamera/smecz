            ...
            <tbody>
                @forelse($deposits as $deposit)
                    <tr>
                        ...
                        <td>
                            <div class="btn--group">
                                <button class="btn btn-outline--base btn--sm @if ($deposit->method_code >= 1000) detailBtn @else disabled @endif" type="button" @if ($deposit->method_code >= 1000) data-info="{{ $details }}" @endif
